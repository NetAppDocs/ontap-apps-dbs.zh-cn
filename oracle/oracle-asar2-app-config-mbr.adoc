...
summary: Oracle 数据库参数 - db_file_multiblock_read_count（ ASA r2） 
searchtitle: Oracle 数据库参数 - db_file_multiblock_read_count（ ASA r2） 
---
...
与AFF/ FAS系统相比，建议没有变化。ONTAP 的行为和 Oracle 最佳实践在ASA r2、 AFF和FAS平台上保持不变。
