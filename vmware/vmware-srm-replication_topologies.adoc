...
有关ONTAP 9 的SnapMirror和SnapVault的最新信息，请参阅 https://www.netapp.com/pdf.html?item=/media/17229-tr-4015-snapmirror-configuration-ontap.pdf["TR-4015 《适用于 ONTAP 9 的 SnapMirror 配置最佳实践指南》。"^]
