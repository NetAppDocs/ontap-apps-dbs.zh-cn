...
NOTE: vVols 需要使用 ONTAP tools for VMware vSphere，该工具充当 ONTAP 的 VASA Provider。有关 vVols 最佳实践，请参阅 link:vmware-vvols-overview.html["采用ONTAP的VMware vSphere虚拟卷(Vvol)"]。
